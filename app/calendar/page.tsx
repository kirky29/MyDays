              ...
              <div className="card-header">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Work day details</p>
                  </div>
                  <button
                    ...
                    <div key={employee.id} className="border border-gray-200 rounded-xl p-4">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex items-center space-x-2">
                          {workDay?.worked && (
                            <div className={`status-indicator ${workDay.paid ? 'status-success' : 'status-warning'}`}></div>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <button
                          ...
                          className={`btn btn-sm ${workDay?.worked ? 'btn-primary' : 'btn-secondary'}`}
                        >
                        ...
                        <button
                          ...
                          className={`btn btn-sm ${
                            workDay?.paid ? 'btn-success' : 
                            workDay?.worked ? 'btn-warning' : 'btn-secondary'
                          }`}
                        >
                          {workDay?.paid ? '✓ Paid' : 
                           workDay?.worked ? 'Mark Paid' : 'N/A'}
                        </button>
                      </div>
                        ...
                        <div className="mt-3 pt-3 border-t border-gray-100">
                          <div className="flex justify-between items-center text-xs">
                            <span className="text-gray-600">
                              Status: <span className={`font-semibold ${workDay.paid ? 'text-green-600' : 'text-amber-600'}`}>
                                {workDay.paid ? 'Paid' : 'Pending'}
                              </span>
                            </span>
